...
import {
  getSanitizedRepoUrl, getNwoFromRepoUrl, fetchAllTags, fetchStatusesForCommit,
  getIdFromGistUrl, createRelease, uploadFileToRelease
} from './github-api';
...
export async function main(argv, showHelp) {
  ...
  for (let file of fileList) {
    ...
    await retryPromise(() => uploadFileToRelease(releaseInfo, file, name));
  }
}
